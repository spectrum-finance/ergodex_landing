...
const SocialLinks = () => {
  return (
    <ul className="social-list">
      ...
      <li className="social-item">
        <a href="https://www.reddit.com/r/ergodex/" target="_blank" className="social-link" rel="noreferrer">
          <RedditIcon />
        </a>
      </li>
      <li className="social-item">
        <a href="https://github.com/ergolabs" target="_blank" className="social-link" rel="noreferrer">
          <GithubIcon />
        </a>
      </li>
    </ul>
